    ...
    >
      <div className="relative mb-20">
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-[#FFFFFF] blur-[120px] -z-10"
        />
      </div>
      ...
      <div className="w-80 h-[1px] bg-white/5 relative overflow-hidden rounded-full">
        <motion.div
          ...
          className="absolute top-0 left-0 h-full bg-[#FFFFFF] shadow-[0_0_15px_rgba(253,252,240,0.5)]"
        />
      </div>

      <motion.div
        className="mt-8 text-[9px] uppercase tracking-[0.8em] font-black text-[#FFFFFF]/30"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.div
        className="mt-4 text-3xl font-black font-mono text-[#FFFFFF]"
      >
        {Math.round(progress)}%
      </motion.div>
    </motion.div>
