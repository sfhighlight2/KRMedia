      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <motion.h2
            ...
            className="max-w-xl text-4xl md:text-7xl font-black text-[#FFFFFF] mb-8 uppercase tracking-tighter"
          >
            Trusted by Visionaries Who <br /> Build for the Long Term
          </motion.h2>
          <motion.div
          ...
          >
            ...
            <p className="text-[11px] uppercase tracking-widest font-black text-[#FFFFFF]/40">Trusted by New York Executives</p>
          </motion.div>
        </div>
          ...
          {TESTIMONIALS.map((t, idx) => (
            ...
            >
              <div className="flex gap-1 mb-8">
                {[1, 2, 3, 4, 5].map(i => (
                  <Star key={i} size={16} className="fill-[#FFFFFF] text-[#FFFFFF]" />
                ))}
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 rounded-full bg-[#FFFFFF]/5 pointer-events-none" />
                </div>
                <div>
                  <p className="font-bold text-[#FFFFFF] uppercase tracking-tight">{t.name}</p>
